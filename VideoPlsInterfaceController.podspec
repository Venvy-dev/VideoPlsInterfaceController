...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/Venvy-dev/VideoPlsInterfaceController.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Zard1096'     => 'mr.zardqi@gmail.com',
                         'LiShaoshuai'  => 'lishaoshuai1990@gmail.com',   
                         'Bill'         => 'fuleiac@gmail.com'          }
  s.source           = { :git => 'https://github.com/Venvy-dev/VideoPlsInterfaceController.git', :tag => s.version.to_s }
  ...
  s.subspec 'VideoOS' do |video|
    ...
    video.dependency 'VideoPlsCytron', '1.8.11'
  end
  ...
  s.subspec 'LiveOS' do |live|
    ...
    live.dependency 'VideoPlsLive', '1.8.11'
  end
